...
const (
	...
	transportHTTPPackage = protogen.GoImportPath("github.com/cnsync/kratos/transport/http")
	bindingPackage       = protogen.GoImportPath("github.com/cnsync/kratos/transport/http/binding")
)
